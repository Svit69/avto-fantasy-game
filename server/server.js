...
const application = new HttpApplication({
  ...
  authController: new TelegramAuthController({ bodyParser, jsonResponder, initDataVerifier: new TelegramInitDataVerifier(process.env.TELEGRAM_BOT_TOKEN) }),
  webhookController: new TelegramWebhookController({ bodyParser, jsonResponder, botClient, appUrl }),
