export class KhlFantasyPointValuePolicy {
  constructor() {
    this.skaterRules = Object.freeze({
      "нападающий": { goals: 50, assists: 30, penalties: -10, shotsOnGoal: 5, blockedShots: 5, hits: 5, takeaways: 10, interceptions: 10 },
      "защитник": { goals: 60, assists: 40, penalties: -10, shotsOnGoal: 5, blockedShots: 10, hits: 5, takeaways: 10, interceptions: 10 },
    });
