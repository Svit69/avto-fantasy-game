export class TelegramWebhookController {
  constructor({ bodyParser, jsonResponder, botClient, appUrl, userMapper, userRepository, logger, summarizer, replyFactory }) {
    Object.assign(this, { bodyParser, jsonResponder, botClient, appUrl, userMapper, userRepository, logger, summarizer, replyFactory });
  }
