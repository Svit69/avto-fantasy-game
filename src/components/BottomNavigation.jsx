...
export function BottomNavigation({ activeSection, onSectionChange }) {
  return (
    <nav className="bottom-nav" aria-label="Разделы приложения">
      {navigationItems.map((item) => {
        ...
        return (
          <button className={isActive ? "bottom-nav__item active" : "bottom-nav__item"} type="button" key={item.label} onClick={() => onSectionChange(item.label)}>
